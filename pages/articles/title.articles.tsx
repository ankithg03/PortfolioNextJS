...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Sree Raksha M R</title>
            <meta name="description" content="Explore articles authored by Sree Raksha M R, a Full Stack Engineer and Developer." />
